...
envsubst '${RPC_PROXY_LISTEN_PORT} ${RPC_UPSTREAM_SCHEME} ${RPC_UPSTREAM_HOST} ${RPC_UPSTREAM_CONNECT_HOST} ${RPC_UPSTREAM_TLS_HOST} ${RPC_UPSTREAM_PATH} ${RPC_CLIENT_QUERY_SEPARATOR}' \
